...
class UserSettings: ObservableObject {
    ...
    init() {
        self.buttonColorString = defaults.object(forKey: "buttonColor") as? String ?? UIColor.StringFromUIColor(color: getGreen())
        self.topBarColorString = defaults.object(forKey: "topBarColor") as? String ?? UIColor.StringFromUIColor(color: getGreen())
        defaults.object(forKey: "minimalistic") as? Int ?? 1 == 1 ? (self.minimalistic = true) : (self.minimalistic = false)
        self.topBarContentColorString = defaults.object(forKey: "topBarContentColor") as? String ?? UIColor.StringFromUIColor(color: self.minimalistic ? getGreen() : .white)
