...
public class Team: Identifiable {
    ...
    public func fetch_info() {
        ...
        let data = RoboScoutAPI.robotevents_request(request_url: "/teams", params: self.id != 0 ? ["id": self.id, "program": RoboScoutAPI.selected_program_id()] : ["number": self.number, "program": [44]])
